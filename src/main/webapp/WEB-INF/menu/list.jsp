              ...
              <div class="row gy-5">
                ...
                <c:forEach var="item" items="${menuList}">
                  <div class="col-lg-4 menu-item">
                    <a href="${pageContext.request.contextPath}/assets/img/menu/${item.imageUrl}" class="glightbox">
                      <img src="${pageContext.request.contextPath}/assets/img/menu/${item.imageUrl}" class="menu-img img-fluid" alt="${item.itemName}">
                    </a>
                    <h4>${item.itemName}</h4>
