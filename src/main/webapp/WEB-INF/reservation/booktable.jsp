      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row g-4 mt-1" data-aos="fade-up" data-aos-delay="150">
          <div class="col-6 col-md-4 col-lg-3">
            <div class="table-card available h-100 text-center p-4">
              <h4>Table 1</h4>
          ...
          <div class="col-6 col-md-4 col-lg-3">
            <div class="table-card reserved h-100 text-center p-4">
              <h4>Table 2</h4>
          ...
          <div class="col-6 col-md-4 col-lg-3">
            <div class="table-card occupied h-100 text-center p-4">
              <h4>Table 3</h4>
